...
echo.%White%[%Red%+%White%] Null Spoof -^> 1 [Read guide.txt for more info about this feature.]
echo.%White%[%Red%+%White%] TPM Bypass -^> 2 [BETA]
echo.%White%[%Red%+%White%] Enable Fortnite Toruney Fix -^> 3
echo.%White%[%Red%+%White%] ARP Fix- ^> 4 
echo.
set /p input=^>^>^>
if /i %input% == 1 goto Null
if /i %input% == 2 goto TPM
if /i %input% == 3 goto toruney 
if /i %input% == 4 goto arp 

:Null
cls
timeout /t 1 >nu1
echo.[debug] Failed to start null spoof. Driver couldnt start.
...
cls
timeout /t 1 >nu1
echo.[debug] Enabling TPM Bypass. . .
timeout /t 6 >nu1
echo.[debug] TPM Bypass was successful. Please restart the spoofer.
pause >nu1
exit /b
...
cls
timeout /t 1 >nu1
echo.[debug] Loading Tourney Spoof Driver. . .
timeout /t 3 >nu1
echo.[debug] Changing SID
timeout /t 4 >nu1
taskkill /f /im explorer.exe >nu1
timeout /t 2 /nobreak >nul
start explorer.exe >nu1
echo.[debug] Spoofing Final Toruney Identifiers . . .
timeout /t 3 >nu1
echo.[debug] Fortnite Toruney Fix was successful.
timeout /t 3 >nu1
exit /b 
